...
export default class PansBox extends Component {
    render() {
        const { 
            id, 
            pansTitle,
                    ...
                    return(
                        <div className="box">
                            <div className="uk-inline-clip uk-transition-toggle uk-light" tabIndex="0" key={id}>
                                <img src={pansPic} alt={pansTitle} draggable="false" />
                                ...
                                <div className="uk-position-center uk-text-center">
                                    <div className="product-info">
                                        ...
                                        <div className="uk-transition-slide-bottom-medium top-trending-price">
                                            <span className="uk-margin-small-right" style={ isDiscount === true ? {textDecoration: 'line-through'} : {textDecoration: 'none'} }>${pansPrice}</span>
                                            { isDiscount === true ? <span>${pansPrice}</span> : null }
                                        </div>
                                    </div>
                                </div>
                            </div>
