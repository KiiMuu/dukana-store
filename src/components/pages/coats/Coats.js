                        ...
                        <div className="sidebar uk-width-1-4@m">
                            <ul data-uk-accordion>
                                ...
                                <li className="uk-open">
                                    <button className="uk-accordion-title uk-text-uppercase">Coats</button>
                                    <div className="uk-accordion-content">
                                        <ul className="uk-list">
                                            <li>Coats</li>
                                            <li>Jackets</li>
                        ...
                        <div className="main uk-width-3-4@m">
                            ...
                            <div>
                                <div className="uk-child-width-1-3@m uk-grid-small" data-uk-grid>
                                    <DukanaConsumer>
                                        {value => {
                                            return value.coats.map(coat => {
                                                return <CoatsBox key={coat.id} coat={coat} />
                                            });
                                        }}
                                    </DukanaConsumer>
                                </div>
